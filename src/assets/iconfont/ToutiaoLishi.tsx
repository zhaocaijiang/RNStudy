...
let ToutiaoLishi: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
ToutiaoLishi.defaultProps = {
  size: 18,
};

ToutiaoLishi = React.memo ? React.memo(ToutiaoLishi) : ToutiaoLishi;

export default ToutiaoLishi;
