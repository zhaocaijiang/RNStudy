...
let ToutiaoZuojiantou: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
ToutiaoZuojiantou.defaultProps = {
  size: 18,
};

ToutiaoZuojiantou = React.memo ? React.memo(ToutiaoZuojiantou) : ToutiaoZuojiantou;

export default ToutiaoZuojiantou;
